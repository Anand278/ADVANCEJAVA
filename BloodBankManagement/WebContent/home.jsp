...
<body>
 ...
 <div class="container-fluid ">
      ...
      >
        ...
        <div class="col-6 text-light" style="font-size: 24px;">
        ...
        <div class="col-2 text-light d-flex justify-content-end">
            <a href="request_blood_form.htm" >Request Blood</a>
        </div>
         <div class="col-2 text-light d-flex justify-content-end">
        	 <a href="donate_blood_form.htm" >Donate Blood</a> 
        </div>
        <div class="col-2 text-light d-flex justify-content-end">
...
<div><h3>Welcome <%=(session.getAttribute("user")!=null)?((User)session.getAttribute("user")).getFirstName():"!!!" %></h3></div>	
